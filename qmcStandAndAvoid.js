...
// find and replace qmcStandAndAvoid with your initials (i.e. ABC)
...
function qmcStandAndAvoid(game) {
    this.player = 1;
    this.radius = 10;
    this.rocks = 0;
    this.kills = 0;
    this.name = "Quinn Stand And Avoid";
    this.color = "Pink";
    this.cooldown = 0;
...
qmcStandAndAvoid.prototype = new Entity();
qmcStandAndAvoid.prototype.constructor = qmcStandAndAvoid;
...
qmcStandAndAvoid.prototype.selectAction = function () {
	 ...
	 * @author Jens Seiler
	 */
	qmcStandAndAvoid.prototype.calculateInterceptionPoint = function(a, v, b, s) {
		var ox = a.x - b.x;
		var oy = a.y - b.y;
...
qmcStandAndAvoid.prototype.collide = function (other) {
    return distance(this, other) < this.radius + other.radius;
};

qmcStandAndAvoid.prototype.collideLeft = function () {
    return (this.x - this.radius) < 0;
};

qmcStandAndAvoid.prototype.collideRight = function () {
    return (this.x + this.radius) > 800;
};

qmcStandAndAvoid.prototype.collideTop = function () {
    return (this.y - this.radius) < 0;
};

qmcStandAndAvoid.prototype.collideBottom = function () {
    return (this.y + this.radius) > 800;
};

qmcStandAndAvoid.prototype.update = function () {
...
qmcStandAndAvoid.prototype.draw = function (ctx) {
    ctx.beginPath();
