...
// find and replace QMC with your initials (i.e. ABC)
...
QMC.prototype = new Entity();
QMC.prototype.constructor = QMC;
...
QMC.prototype.selectAction = function () {
...
QMC.prototype.collide = function (other) {
    return distance(this, other) < this.radius + other.radius;
};

QMC.prototype.collideLeft = function () {
    return (this.x - this.radius) < 0;
};

QMC.prototype.collideRight = function () {
    return (this.x + this.radius) > 800;
};

QMC.prototype.collideTop = function () {
    return (this.y - this.radius) < 0;
};

QMC.prototype.collideBottom = function () {
    return (this.y + this.radius) > 800;
};

QMC.prototype.update = function () {
...
QMC.prototype.draw = function (ctx) {
    ctx.beginPath();
