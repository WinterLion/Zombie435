...
// find and replace qmcSniper with your initials (i.e. ABC)
...
function qmcSniper(game) {
    this.player = 1;
    this.radius = 10;
    this.rocks = 0;
    this.kills = 0;
    this.name = "Quinn Sniper";
    this.color = "Green";
    this.cooldown = 0;
...
qmcSniper.prototype = new Entity();
qmcSniper.prototype.constructor = qmcSniper;
...
qmcSniper.prototype.selectAction = function () {
	 ...
	 * @author Jens Seiler
	 */
	qmcSniper.prototype.calculateInterceptionPoint = function(a, v, b, s) {
		var ox = a.x - b.x;
		var oy = a.y - b.y;
...
qmcSniper.prototype.collide = function (other) {
    return distance(this, other) < this.radius + other.radius;
};

qmcSniper.prototype.collideLeft = function () {
    return (this.x - this.radius) < 0;
};

qmcSniper.prototype.collideRight = function () {
    return (this.x + this.radius) > 800;
};

qmcSniper.prototype.collideTop = function () {
    return (this.y - this.radius) < 0;
};

qmcSniper.prototype.collideBottom = function () {
    return (this.y + this.radius) > 800;
};

qmcSniper.prototype.update = function () {
...
qmcSniper.prototype.draw = function (ctx) {
    ctx.beginPath();
